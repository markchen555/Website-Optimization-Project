...
var resizePizzas = function(size) {
  ...
  function changeSliderLabel(size) {
    switch(size) {
      // change querySelector to getElementsByClassName to improve speed.
      case "1":
  ...
  function changePizzaSizes(size) {
    ...
    // factor out .randomPizzaContainer and change querySelectorAll to getElementsByClassName (make sure to remove change from ".randomPizzaContainer" to "randomPizzaContainer")
    ...
    for (var i = 0; i < randomPizzas.length; i++) {
      // Move the following code outside the loop
...
// move this line outside the for loop to decrease load time. 
...
function updatePositions() {
  ...
  // replace "querySelectorAll" method with "getElementsByClassName"
  var items = document.getElementsByClassName('mover');
  // declare scroll variable to increase fps
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // change i < 200 to i < 30 because we don't need that much in the background to reduce fps
